...
<body>
<%--<form action="${pageContext.request.contextPath}/servlet.jpg" method="post">--%>
    ...
    <div class="heading">
        ...
        <form action="${pageContext.request.contextPath}/servlet.jpg" method="post">
            ...
            <div class="input-group input-group-lg">
                ...
                <input type="text" id="data" name="data" class="form-control" placeholder="Message">
            </div>
