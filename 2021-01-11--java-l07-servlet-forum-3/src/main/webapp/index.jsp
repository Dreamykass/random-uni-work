...
<div class="row">
    ...
    <div class="rightcolumn">
        ...
        <div class="card">
            <h2>Total questions and answers</h2>
            <p>
                questions:
                <%
                    if (database.QuestionDatabase.getAllQuestions() != null)
                        out.print(" " + database.QuestionDatabase.getAllQuestions().size());
                %><br>
                answers:
                <%
        ...
        <div class="card">
            ...
            <div class="fakeimg">
                <%
                    List<Question> qq2 = database.QuestionDatabase.getAllQuestions();
                    Question q = null;
                    if (qq2 != null && qq2.size() > 3) {
                        Collections.sort(qq2);
                        Collections.reverse(qq2);
                        q = qq2.get(0);
                        out.print("<a href=\"details.jsp?hashcode=" + q.hashCode() + "\">" + q.questionBody + "</a>");
                    }
                %>
            </div>
            <br>
